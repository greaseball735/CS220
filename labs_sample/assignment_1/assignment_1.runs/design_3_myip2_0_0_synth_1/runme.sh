...
HD_PWD='/users/btech/rohitv23/assignment_1/assignment_1.runs/design_3_myip2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_myip2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_myip2_0_0.tcl
