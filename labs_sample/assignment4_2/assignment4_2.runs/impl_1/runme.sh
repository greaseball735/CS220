...
HD_PWD='/users/btech/rohitv23/assignment4_2/assignment4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_file_32x32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_file_32x32.tcl -notrace
