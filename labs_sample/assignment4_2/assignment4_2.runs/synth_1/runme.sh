...
HD_PWD='/users/btech/rohitv23/assignment4_2/assignment4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_file_32x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_file_32x32.tcl
