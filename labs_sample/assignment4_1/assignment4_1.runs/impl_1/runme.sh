...
HD_PWD='/users/btech/rohitv23/assignment4_1/assignment4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_512_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sram_512_8.tcl -notrace
