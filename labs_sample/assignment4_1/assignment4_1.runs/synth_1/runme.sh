...
HD_PWD='/users/btech/rohitv23/assignment4_1/assignment4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_512_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_512_8.tcl
