...
HD_PWD='/users/btech/rohitv23/assignment3_monday2/assignment3_monday2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fms.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fms.tcl -notrace
