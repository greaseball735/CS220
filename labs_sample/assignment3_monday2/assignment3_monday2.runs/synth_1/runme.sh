...
HD_PWD='/users/btech/rohitv23/assignment3_monday2/assignment3_monday2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fms.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fms.tcl
