...
HD_PWD='/users/btech/rohitv23/assignment3_monday1/assignment3_monday1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gray_FSM.tcl -notrace
