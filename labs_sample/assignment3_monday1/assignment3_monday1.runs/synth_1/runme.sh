...
HD_PWD='/users/btech/rohitv23/assignment3_monday1/assignment3_monday1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gray_FSM.tcl
